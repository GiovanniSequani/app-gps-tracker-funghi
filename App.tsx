  ...
  return (
    <SafeAreaView style={aStyles.root}>
      ...
      <View style={aStyles.header}>
        ...
        <Text style={aStyles.headerSub}>{routes.length} percorso{routes.length !== 1 ? 'i' : ''} salvato{routes.length !== 1 ? 'i' : ''}</Text>
      </View>
        ...
        <View style={aStyles.modalBackdrop}>
          <View style={aStyles.modalCard}>
            ...
            <TextInput
              ...
              autoFocus
            />
            <Button title="Salva e Condividi" onPress={saveAndShareGPX} color={UI.green} />
            <View style={{ height: 8 }} />
