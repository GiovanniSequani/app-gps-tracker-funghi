...
const styles = StyleSheet.create({
  ...
  description: { color: COLORS.muted, fontSize: 13, lineHeight: 20 }, deadline: { flexDirection: 'row', alignItems: 'flex-start', gap: 7 }, deadlineText: { flex: 1, color: COLORS.amber, fontSize: 12, lineHeight: 18 },
  error: { color: '#ffaaaa', fontSize: 12, lineHeight: 18 }, versionError: { backgroundColor: '#2a1e13', borderRadius: 8, padding: 12, gap: 5 }, versionTitle: { color: COLORS.amber, fontWeight: '800' },
  ...
  actions: { gap: 10, borderTopWidth: 1, borderTopColor: COLORS.border, paddingTop: 13 }, checkRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 }, checkbox: { width: 22, height: 22, borderRadius: 5, borderWidth: 1, borderColor: COLORS.border, alignItems: 'center', justifyContent: 'center' }, checkboxOn: { backgroundColor: COLORS.green, borderColor: COLORS.green }, tick: { color: '#0a110b', fontWeight: '900' }, checkText: { flex: 1, color: COLORS.text, fontSize: 12, lineHeight: 18 },
  primary: { minHeight: 44, borderRadius: 9, backgroundColor: COLORS.green, alignItems: 'center', justifyContent: 'center' }, primaryText: { color: '#0a110b', fontWeight: '800' }, disabled: { opacity: 0.45 }, refuse: { minHeight: 40, alignItems: 'center', justifyContent: 'center' }, refuseText: { color: COLORS.red, fontWeight: '700', fontSize: 12 }, support: { color: COLORS.green, fontWeight: '700', fontSize: 12 },
  footer: { flexDirection: 'row', gap: 8 }, secondary: { flex: 1, minHeight: 42, borderWidth: 1, borderColor: COLORS.border, borderRadius: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 }, secondaryText: { color: COLORS.text, fontWeight: '700', fontSize: 12 },
});
