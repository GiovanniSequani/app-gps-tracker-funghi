...
const styles = StyleSheet.create({
  ...
  tab: { flex: 1, minHeight: 48, borderRadius: 8, borderWidth: 1, borderColor: COLORS.border, flexDirection: 'row', gap: 6, alignItems: 'center', justifyContent: 'center' },
  tabActive: { backgroundColor: COLORS.panel2, borderColor: COLORS.green },
  tabText: { color: COLORS.text, fontWeight: '700' },
  label: { color: COLORS.text, fontSize: 14, fontWeight: '700', marginTop: 5 },
  input: { minHeight: 48, borderWidth: 1, borderColor: COLORS.border, borderRadius: 8, backgroundColor: COLORS.panel, color: COLORS.text, fontSize: 16, paddingHorizontal: 12 },
  hint: { color: COLORS.muted, fontSize: 13, lineHeight: 19 },
  contributionNote: { color: '#c7d8c8', fontSize: 14, lineHeight: 21, padding: 11, borderRadius: 7, borderLeftWidth: 3, borderLeftColor: COLORS.green, backgroundColor: COLORS.panel2 },
  forgotButton: { alignSelf: 'flex-end', paddingVertical: 4, paddingLeft: 10 },
  forgotText: { color: COLORS.green, fontSize: 14, fontWeight: '700' },
  ...
  consentText: { flex: 1, color: COLORS.text, fontSize: 14, lineHeight: 21 },
  legalLink: { color: COLORS.green, fontSize: 14, fontWeight: '700', marginLeft: 32, marginTop: -6 },
  primary: { minHeight: 48, borderRadius: 9, backgroundColor: COLORS.green, paddingHorizontal: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
